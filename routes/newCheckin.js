...
let newCheckin = (req, res) => {
    ...
    db.none(`INSERT into dgdg_checkins (creation_date, user_id, goal, goal_outcome, 
        goal_improvements, self_help, self_help_response, help_others, help_others_response, checkin_privacy) VALUES 
        (CURRENT_TIMESTAMP, $1, $2, $3, $4, $5, $6, $7, $8, $9)`, [decoded.id, req.body.goal,
        req.body.goal_outcome, req.body.goal_improvements, req.body.self_help, req.body.self_help_response,
        req.body.help_others, req.body.help_others_response, Number(req.body.checkin_privacy)])
